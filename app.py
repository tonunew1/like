...
LATEST_HEADERS = {
    ...
    'X-GA': "v1 1",
    'ReleaseVersion': "OB53"            # গেম release version (প্যাচ আপডেটে পরিবর্তন হবে)
}
...
async def send_request(encrypted_uid, token, url):
    try:
        ...
        headers = dict(LATEST_HEADERS)  # copy latest headers
...
def home():
    return jsonify({
        ...
        "discord": "https://discord.gg/qpEmGvwwJC"
    })
